    ...
    extend: {
      ...
      colors: {
        ...
        colors: {
          ...
          border_message_pink_opacity: '#ad6da1',
        },
      },
      backgroundImage: {
        ...
        //denys
        g_pink_message: 'linear-gradient(180deg, #D64F85 0%, #8B3DBB 100%);',
        g_pink_message_opacity: 'linear-gradient(180deg, rgba(214,79,133,0.8) 0%, rgba(139,61,187,0.8) 100%)',
      ...
      boxShadow: {
        ...
        pinkPurple: '0px 0px 10px rgba(241,98,152,0.4), 0px 8px 20px rgba(166,79,217,0.4)',
      },
      backgroundSize: {
        '110': '110%',
      },
